<?php
    ...
    StaticService::includeAppJsStatic('/js/web/account/index.js',['depend'=>\app\assets\WebAsset::className()]);
?>
<?=Yii::$app->view->render("@app/modules/web/views/common/tab_account.php",['current'=>'index'])?>
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-bordered m-t">
                    ...
                    <tr>
                        ...
                        <td><?=$_item['email']?></td>
                        <td>
                            <a  href="<?=UrlService::buildWebUrl('account/info',['uid'=>$_item['uid']])?>">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ul class="pagination pagination-lg pull-right" style="margin: 0 0 ;">
                            <?php for($_page = 1;$_page<=$pages['total_page'];$_page++):?>
                                ...
                                <?php else:?>
                                    <li><a href="<?=UrlService::buildWebUrl('/account/index',['p'=>$_page])?>"><?=$_page?></a></li>
                                <?php endif;?>
                            <?php endfor;?>
                        </ul>
                    </div>
